      ...
      <div className="container p-tb-32">
        <p className="t-center" style={{ color: '#888' }}>
          <span className="font-size-18px">
            CÔNG TY CỔ PHẦN THƯƠNG MẠI - DỊCH VỤ Store
          </span>
          <br />
          <strong>Trụ sở:</strong>&nbsp;154 Đội Cấn, Phường Đội Cấn, Quận Ba Đình, Hà Nội
          <br />
          <strong>Văn phòng:</strong>&nbsp;26/63 phố Lâm Hạ, phường Bồ Đề, quận Long Biên, Hà Nội
          <br />
          <strong>Điện&nbsp;thoại:</strong>&nbsp;0911985599 |{' '}
          <strong>Email:</strong>&nbsp;hieupt71099@gmail.com&nbsp;|{' '}
        ...
        <div className="d-flex align-i-center justify-content-center">
          ...
          <div className="d-flex align-i-center m-lr-32">
            ...
            <div className="t-center m-l-16">
              ...
              <h2 style={{ color: '#CE1F26' }}>0911985599</h2>
            </div>
          </div>
